...
(function() {
  var Babel, Babel_es2015, CHUNK_CODE, Dict, FS, IPC, Indexer, PACK_CODE, Packer, Path, Paths, Reg, babelOptions, getChunkCode, getPackCode, nga,
  ...
  Packer = (function() {
    ...
    Packer.prototype.update = function(files) {
      var base, error, errors, f, file, j, k, len, len1, path, tmp;
      errors = this.errors || [];
      this.errors = [];
      base = this.cfg.base;
